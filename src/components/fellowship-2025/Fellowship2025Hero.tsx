const HERO_BG = '/uploads/2025/04/Young-ent-2.jpg'

export function Fellowship2025Hero() {
  return (
    <div className="mx-auto max-w-[1200px] px-[18px] pb-10 pt-7 md:px-8">
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(180deg, rgba(0, 39, 64, 0.72) 0%, rgba(0, 39, 64, 0.78) 100%), url('${HERO_BG}')`,
      ...
      >
        <h1 className="mx-auto mb-3 max-w-[900px] text-[clamp(2rem,4.4vw,3rem)] font-bold leading-[1.15] tracking-[-0.02em] text-white">
          Future Trade Leaders Fellowship Community 2025
        </h1>
        <p className="mx-auto max-w-[760px] text-[clamp(1rem,1.8vw,1.35rem)] font-normal opacity-92">
          Meet the inspiring individuals and expert minds shaping Africa and the Caribbean&apos;s future
          in trade.
        </p>
      </div>
